...
def RigidezGlobal(nn,ne,MAT,ESP,XY,IJ):
...
def Ftbilinear(dJ,d,p1,p2,valor,te):
    ...
    return F
#Montagem do vetor global de forças distribuídas nas faces dos elementos
...
def CalculaTensaoMalha(nn,ne,MAT,ESP,XY,IJ,U):  
